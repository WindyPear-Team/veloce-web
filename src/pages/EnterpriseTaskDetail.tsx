...
type DialogKind = "participant" | "department" | "device" | "quota" | null
...
export default function EnterpriseTaskDetail() {
  ...
  const closeDialog = () => { setDialog(null); setMemberID(""); setDepartmentID(""); setDeviceID(""); setParentQuotaID(""); setAmount("") }
